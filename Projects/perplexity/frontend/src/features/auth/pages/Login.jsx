...
/* Perplexity logo — three stacked layers with perspective tilt */
const Logo = () => (
    ...
    <div className={`root ${isDark ? "dark" : "light"}`}>
      ...
      <div className="wrap">
        ...
        <div className="card">
          ...
          <form onSubmit={onSubmit} className="form" noValidate>
            {/* Email */}
            <div className={`fld ${focused === "email" ? "fld-f" : ""}`}>
      ...
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .err{display:flex;align-items:center;gap:7px;background:var(--err-bg);
          border:1px solid var(--err-b);border-radius:9px;padding:10px 12px;
          font-size:13px;color:var(--err-c);margin-bottom:20px;animation:shake .3s ease}
        ...
        .eye{position:absolute;right:0;top:50%;transform:translateY(-50%);
          background:none;border:none;cursor:pointer;color:var(--t3);padding:4px;display:flex;transition:color .15s}
